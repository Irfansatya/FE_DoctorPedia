...
import styles from "./HomePageTapiBuatRoleLain.module.css"; // Import the CSS module

const HomePageTapiBuatRoleLain: Component = () => {
    ...
    <div class={`${styles.container} ${styles.homepage}`}>
      <header class={styles.header}>
        ...
        <div class="logo">
          ...
          <h2 class={styles.h2}>Admin-side</h2>
        </div>
...
export default HomePageTapiBuatRoleLain;
